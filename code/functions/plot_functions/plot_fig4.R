...
plot_fig4<-function(x){
x_doesnt_do_anything <- x
...
sim_tst<-sma_predmat_hist[idx_comp,'sim 0']
sim_4c<-sma_predmat_4c[idx_comp,'sim 0']
obs_tst<-sma_hist_vars[idx_comp,'obs']
sim_tst1<-sma_predmat_hist[idx_comp1,'sim 0']
sim_4c1<-sma_predmat_4c[idx_comp1,'sim 0']
...
#--------------------------------------------------------------
png(paste('./figures_tables/fig4.png',sep=''),width=768,height=1024)
